...
class Window(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        ## Description
        self.description_label = QtGui.QLabel('Description (0/1024)')
    ...
    def description_input_limit(self):
        if len(self.description_tb.toPlainText()) > 1024:
            self.description_tb.setText(self.description_tb.toPlainText()[:1024])
        self.description_label.setText('Description ({}/1024)'.format(len(self.description_tb.toPlainText())))
    ...
    def updateList(self, index):
        ...
        self.name_tb.setText('{}'.format(self.craft_list[index].split('.')[1].strip()))
        ...
        def upload_finished():
            if not progress.wasCanceled():
                ...
                if 'uid' in data:
                    ...
                    self.user_data['api'] = '{}'.format(self.api_token_tb.text())
                    self.dump_user_data()
                else:
